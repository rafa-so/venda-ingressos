...
import model.Venda;
import serialize.VendaSerializer;

public class GeradorVendas {

	private static Random rand = new Random();
	private static long operacao = 0;
	private static BigDecimal valoIngresso = BigDecimal.valueOf(500);
	...
	public static Venda geraVenda() {
		long cliente = rand.nextLong();
		int qtdIngressos = rand.nextInt(10);
		return new Venda(operacao++, 
				cliente, qtdIngressos, 
				valoIngresso.multiply(BigDecimal.valueOf(qtdIngressos)));
	}
}